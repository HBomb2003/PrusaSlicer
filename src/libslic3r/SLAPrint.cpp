...
void SLAPrint::process()
{
    ...
    auto slice_model = [this, ilhs, ilh](SLAPrintObject& po) {
        ...
        auto minZs = scale_(minZ);
        auto maxZs = scale_(maxZ);
...
//        bool flpXY = m_printer_config.display_orientation.getInt() == SLADisplayOrientation::sladoPortrait;
        ...
        const double width              = scale_(m_printer_config.display_width.getFloat());
        const double height             = scale_(m_printer_config.display_height.getFloat());
